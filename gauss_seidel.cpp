// gauss_seidel.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	do {
		x1 = f(b[0], a[0][1], x2, a[0][2], x3, a[0][0]);
		x2 = f(b[1], a[1][0], x1, a[1][2], x3, a[1][1]);
		x3 = f(b[2], a[2][0], x1, a[2][1], x2, a[2][2]);
